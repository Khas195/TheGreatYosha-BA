...
namespace PixelCrushers.DialogueSystem.Twine
{
	...
	public class TwineImportWindow : EditorWindow
	{
		...
		protected WordHighlightingDict highlightDictionary = null;
		...
		protected virtual void DrawDatabaseField()
		{
			...
			highlightDictionary = EditorGUILayout.ObjectField("Highlight Dictionary", highlightDictionary, typeof(WordHighlightingDict), false) as WordHighlightingDict;
		...
		protected virtual void ImportStory(StoryInfo storyInfo)
		{
			...
			twineImporter.ConvertStoryToConversation(database, template, story, storyInfo.actorID, storyInfo.conversantID, storyInfo.splitPipes, prefs.useTwineNodePositions, highlightDictionary);
		}

...
namespace PixelCrushers.DialogueSystem
{
	...
	public class DialogueActor : MonoBehaviour
	{
		...
		public virtual string AdjustSubtitleColor(Subtitle subtitle)
		{
			...
			var displayName = DialogueLua.GetActorField(subtitle.speakerInfo.nameInDatabase, "Display Name").asString;
			if (displayName == "")
			{
				displayName = subtitle.speakerInfo.Name;
			}
			return !standardDialogueUISettings.setSubtitleColor ? text
			    : (standardDialogueUISettings.applyColorToPrependedName ?
				UITools.WrapTextInColor(displayName + standardDialogueUISettings.prependActorNameSeparator, standardDialogueUISettings.subtitleColor) + text
